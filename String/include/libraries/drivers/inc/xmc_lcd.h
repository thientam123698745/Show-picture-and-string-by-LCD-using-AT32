...
typedef struct
{
  ...
  void (*displayF)(struct tImage input);
...
#define Horizon                          0 //1 thi nam ngang, 0 la nam doc
#define HAVE_BACKGROUND                  0 //neu khac 0 thi la mau cua background
#define CHAR_COLOR                       0xF800 //mau cua chu
#define CHAR_SIZE_DEVIDE                 2   // kich thuoc chu nen dung 1, 2, 4, 8
#define Enter_Sleep_Mode 				 0x10
#define Sleep_Out						 0x11
#define Partial_Mode_ON                  0x12//màn hình ko cảm ứng
#define Normal_Display_Mode_ON 			 0x13//màn hình cảm ứng
...
void displayF(char a,unsigned* x,unsigned* y);
